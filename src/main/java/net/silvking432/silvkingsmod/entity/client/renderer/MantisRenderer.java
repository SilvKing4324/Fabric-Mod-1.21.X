...
import net.silvking432.silvkingsmod.entity.client.model.MantisModel;
...
import net.silvking432.silvkingsmod.entity.custom.MantisVariant;
...
public class MantisRenderer extends MobEntityRenderer<MantisEntity, MantisModel<MantisEntity>> {
    private static final Map<MantisVariant, Identifier> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(MantisVariant.class), map -> {
                map.put(MantisVariant.DEFAULT,
                        Identifier.of(SilvKingsMod.MOD_ID, "textures/entity/mantis/mantis.png"));
                map.put(MantisVariant.ORCHID,
                        Identifier.of(SilvKingsMod.MOD_ID, "textures/entity/mantis/mantis_orchid.png"));
                //Mehr
                /*
                     map.put(MantisVariant.ORCHID,
                        Identifier.of(SilvKingsMod.MOD_ID, "textures/entity/mantis/mantis_orchid.png"));
    ...
    public MantisRenderer(EntityRendererFactory.Context context) {
        super(context, new MantisModel<>(context.getPart(MantisModel.MANTIS)), 0.75f); // Schatten
    }
