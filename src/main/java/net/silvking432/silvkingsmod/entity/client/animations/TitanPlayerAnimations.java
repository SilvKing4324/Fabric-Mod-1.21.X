...
public class TitanPlayerAnimations {
    public static final Animation ANIM_TITAN_PLAYER_IDLE = Animation.Builder.create(2f).looping()
    ...
    public static final Animation ANIM_TITAN_PLAYER_WALKING = Animation.Builder.create(1f).looping()
            .addBoneAnimation("right_arm",
                    new Transformation(Transformation.Targets.ROTATE,
                            new Keyframe(0f, AnimationHelper.createRotationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR),
            ...
            .addBoneAnimation("left_leg",
                    new Transformation(Transformation.Targets.ROTATE,
                            ...
                            new Keyframe(1f, AnimationHelper.createRotationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR))).build();
    public static final Animation ANIM_TITAN_PLAYER_ATTACK = Animation.Builder.create(1f).looping()
            .addBoneAnimation("right_arm",
                    new Transformation(Transformation.Targets.ROTATE,
                            new Keyframe(0f, AnimationHelper.createRotationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR),
                            new Keyframe(0.25f, AnimationHelper.createRotationalVector(30f, 0f, 5f),
                                    Transformation.Interpolations.LINEAR),
