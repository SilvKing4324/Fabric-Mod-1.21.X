...
public class DarkAnvilBlock extends FallingBlock {
    public static final MapCodec<DarkAnvilBlock> CODEC = createCodec(DarkAnvilBlock::new);
    ...
    private static final Text TITLE = Text.translatable("container.silvkingsmod.dark_anvil");
    ...
    @Override
    public MapCodec<DarkAnvilBlock> getCodec() {
        return CODEC;
    }

    public DarkAnvilBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    protected NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
        return new ExtendedScreenHandlerFactory<BlockPosPayload>() {
            @Override
            ...
            public ScreenHandler createMenu(int syncId, PlayerInventory inventory, PlayerEntity player) {
                return new DarkAnvilScreenHandler(syncId, inventory, ScreenHandlerContext.create(world, pos));
            }
        };
    }
