...
import net.silvking432.silvkingsmod.entity.client.animations.MantisAnimations;
...
public class MantisModel<T extends MantisEntity> extends SinglePartEntityModel<T> {
    public static final EntityModelLayer MANTIS = new EntityModelLayer(Identifier.of(SilvKingsMod.MOD_ID, "mantis"), "main");
