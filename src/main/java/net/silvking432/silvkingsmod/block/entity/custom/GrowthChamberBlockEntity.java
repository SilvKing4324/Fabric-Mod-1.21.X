...
import net.silvking432.silvkingsmod.recipe.GrowthChamberRecipe;
import net.silvking432.silvkingsmod.recipe.GrowthChamberRecipeInput;
...
public class GrowthChamberBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    public Text getDisplayName() {
        return Text.translatable("block.silvkingsmod.growth_chamber");
    }
    ...
    private boolean hasRecipe() {
        ...
        return canInsertAmountIntoOutputSlot(output.getCount()) && canInsertItemIntoOutputSolot(output);
    }

    private Optional<RecipeEntry<GrowthChamberRecipe>> getCurrentRecipe() {
        return this.getWorld().getRecipeManager().getFirstMatch(ModRecipes.GROWTH_CHAMBER_TYPE, new GrowthChamberRecipeInput(inventory.get(INPUT_SLOT)), this.getWorld());
    }

    private boolean canInsertItemIntoOutputSolot(ItemStack output) {
