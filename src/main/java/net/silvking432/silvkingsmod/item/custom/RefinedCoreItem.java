...
public class RefinedCoreItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        ...
        if (traits != null && !traits.isEmpty()) {
            tooltip.add(Text.literal("Core Traits:").formatted(Formatting.GOLD));
            ...
            tooltip.add(Text.literal("Unstable Core: No traits found").formatted(Formatting.DARK_RED, Formatting.ITALIC));
        }
