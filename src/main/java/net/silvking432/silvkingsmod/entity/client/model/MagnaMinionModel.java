...
import net.silvking432.silvkingsmod.entity.client.animations.TitanPlayerAnimations;
import net.silvking432.silvkingsmod.entity.custom.MagnaMinionEntity;
import org.joml.Vector3f;

public class MagnaMinionModel<T extends MagnaMinionEntity> extends BipedEntityModel<T> {
    public static final EntityModelLayer MAGNA_MINION = new EntityModelLayer(Identifier.of(SilvKingsMod.MOD_ID, "magna_minion"), "main");

    private final ModelPart root;

    public MagnaMinionModel(ModelPart root) {
        super(root);
        this.root = root;
    }
