...
import net.silvking432.silvkingsmod.entity.ai.TitaniumEscapeAndGapGoal;
...
public class TitanPlayerEntity extends HostileEntity {
    ...
    protected void initEquipment(net.minecraft.util.math.random.Random random, LocalDifficulty localDifficulty) {
        ...
        ItemStack boots = new ItemStack(ModItems.TITANIUM_BOOTS);
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(1, new TitaniumEscapeAndGapGoal(this));
        this.goalSelector.add(2, new TitaniumAttackGoal(this,1.0,true));
        this.goalSelector.add(3, new TemptGoal(this, 1.25D, Ingredient.ofItems(ModItems.TITANIUM_INGOT), false));
...
/*
    ...
    */
    ...
    public void useGoldenApple() {
        this.goldenApplesLeft--;
    }

    public boolean isGapping() {
        return this.isGapping;
    }

    public void setGapping(boolean gapping) {
        this.isGapping = gapping;
    }
