...
public class ModEnchantments {
    ...
    public static final RegistryKey<Enchantment> LIGHTNING_STRIKER =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(SilvKingsMod.MOD_ID, "lightning_striker"));

    public static final RegistryKey<Enchantment> SMELTING_TOUCH =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(SilvKingsMod.MOD_ID, "smelting_touch"));
    ...
    public static void bootstrap(Registerable<Enchantment> registerable) {
        ...
        register(registerable, SMELTING_TOUCH, Enchantment.builder(Enchantment.definition(
                ...
                new SmeltingTouchEnchantmentEffect()));
    }
